...
Que es lo que obtienes cuando organizas una agrupacion (cluster) de roqueros
(rockers)? Un festival!
...
Para hacerlo usamos contenedores [Docker](https://docker.com), con imagenes
...
codigo en un mismo contenedor, y lo usamos como referencia para comparar el
resultado después.
...
[hacer
asi](http://stackoverflow.com/questions/27937185/assign-static-ip-to-docker-container/35359185#35359185)
...
corre como el contenedor primario que dirije contenedores secundarios.
...
instancias de un mismo Dockerfile
