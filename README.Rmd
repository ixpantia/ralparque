...
1.  R Al Parque es una prueba de concepto para coordinar contenedores Docker y
    hacerlos trabajar en conjunto como un grupo (*EN:cluster*) de trabajadores R
2.  bajo coordinación del paquete `snow`. En este momento no le tenemos una
...
Compose, y quizás despues en combinación con Swarm. TODO: Orquestar todos los
contenedores dentro de Kubernetes.
